...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_utilizationstartvalue = QtWidgets.QLabel(
            self.groupbox_configurations
        )
        self.label_utilizationstartvalue.setGeometry(QtCore.QRect(275, 32, 155, 25))
        self.label_utilizationstartvalue.setObjectName(
            "label_utilizationstartvalue"
        )  # utilization start value
        ...
        self.label_utilizationendvalue.setObjectName(
            "label_utilizationendvalue"
        )  # utilization end value
        ...
        self.label_utilizationstep.setObjectName(
            "label_utilizationstep"
        )  # utilization step
        ...
        self.label_numberofsegments.setObjectName(
            "label_numberofsegments"
        )  # num_of_segment
        ...
        self.label_suspensionminvalue.setObjectName(
            "label_suspensionminvalue"
        )  # suspension length min value
        ...
        self.label_suspensionmaxvalue.setObjectName(
            "label_suspensionmaxvalue"
        )  # suspension length max
        ...
        self.formLayout_1.setWidget(
            5, QtWidgets.QFormLayout.LabelRole, self.proportional
        )
        ...
        self.seifdamip.setToolTip(
            "Shortest Execution Interval First Deadline Assignment - MILP"
        )
        ...
        self.gmfpa.setToolTip(
            "Generalized Multiframe Task Model with Parameter Adaptation - Set granularity of time steps"
        )
        ...
        self.casini18 = QtWidgets.QCheckBox(self.formLayoutWidget_1)
        self.casini18.setObjectName("casini18")
        self.casini18.setText("Casini18")
        self.casini18.setToolTip(
            "Non-preemptive execution of segments. Specify Timeout (0=no timeout)"
        )
        self.formLayout_1.setWidget(8, QtWidgets.QFormLayout.LabelRole, self.casini18)
        ...
        self.formLayout_2.setWidget(
            1, QtWidgets.QFormLayout.FieldRole, self.pathmindddg
        )
        ...
        self.pathminddnd.setToolTip(
            "Pattern-Clairvoyant Shorter Segment Shorter Deadline"
        )
        self.formLayout_2.setWidget(
            2, QtWidgets.QFormLayout.LabelRole, self.pathminddnd
        )
        ...
        self.formLayout_2.setWidget(
            2, QtWidgets.QFormLayout.FieldRole, self.pathminddndg
        )
        ...
        self.formLayout_2.setWidget(
            3, QtWidgets.QFormLayout.LabelRole, self.pathpbminddd
        )
        ...
        self.formLayout_2.setWidget(
            3, QtWidgets.QFormLayout.FieldRole, self.pathpbmindddg
        )
        ...
        self.pathpbminddnd.setToolTip(
            "Pattern-Clairvoyant Proportional Deadline with A Bias"
        )
        self.formLayout_2.setWidget(
            4, QtWidgets.QFormLayout.LabelRole, self.pathpbminddnd
        )
        ...
        self.formLayout_2.setWidget(
            4, QtWidgets.QFormLayout.FieldRole, self.pathpbminddndg
        )
        ...
        self.scedf.setToolTip(
            "Suspension as Computation Earliest-Deadline-First (SCEDF)"
        )
        ...
        self.scairrm.setToolTip(
            "Suspension as Computation (SC) and As Interference Restarts (AIR) Rate-Monotonic (RM)"
        )
        ...
        self.scairopa.setToolTip(
            "Suspension as Computation (SC) and As Interference Restarts (AIR) Optimal Priority Assignment (OPA) "
        )
        ...
        self.edagmfopa.setToolTip(
            "Fixed Relative Deadline (FRD) and Generalized Multiframe (GMF) Optimal Priority Assignment (OPA) "
        )
        ...
        self.formLayout_3.setWidget(
            6, QtWidgets.QFormLayout.LabelRole, self.milpreleasejitter
        )

        self.srsr = QtWidgets.QCheckBox(self.formLayoutWidget_3)
        self.srsr.setObjectName("srsr")
        self.srsr.setText("SRSR")
        self.srsr.setToolTip(
            "Schedulability Analysis with synchronous release sequence refinement"
        )
        ...
        self.passopa.setToolTip(
            "Priority Assignment algorithm for Self-Suspending Systems - Optimal-Priority Assignment"
        )
        ...
        self.formLayout_4.setWidget(
            6, QtWidgets.QFormLayout.LabelRole, self.uniframework
        )
        ...
        self.mp_check.stateChanged.connect(
            lambda: selectionchange_plot(self.combobox_plot)
        )
        ...
        self.combobox_plot.currentIndexChanged.connect(
            lambda: selectionchange_plot(self.combobox_plot)
        )
        ...
        def setSchemes():
            ...
            if gmultiplot == "Tasks per Set":
                garwrap = [
                    self.tasksperset_p1.value(),
                    self.tasksperset_p2.value(),
                    self.tasksperset_p3.value(),
                ]
            elif gmultiplot == "Number of Segments":
                garwrap = [
                    self.numberofsegs_p1.value(),
                    self.numberofsegs_p2.value(),
                    self.numberofsegs_p3.value(),
                ]
            elif gmultiplot == "Suspension Length":
                garwrap = [
                    self.slengthminvalue_p1.value(),
                    self.slengthminvalue_p2.value(),
                    self.slengthminvalue_p3.value(),
                    self.slengthmaxvalue_p1.value(),
                    self.slengthmaxvalue_p2.value(),
                    self.slengthmaxvalue_p3.value(),
                ]
            ...
            if self.seifdamind.isChecked():
                if gNumberOfSegs > 2:
                    ...
                    error_msg.setInformativeText(
                        "SEIFDA-minD does not work for more than two segements."
                    )
                    error_msg.exec_()
                else:
            ...
            if self.seifdamaxd.isChecked():
                if gNumberOfSegs > 2:
                    ...
                    error_msg.setInformativeText(
                        "SEIFDA-maxD does not work for more than two segements."
                    )
                    error_msg.exec_()
                else:
            ...
            if self.seifdapbmind.isChecked():
                if gNumberOfSegs > 2:
                    ...
                    error_msg.setInformativeText(
                        "SEIFDA-PBminD does not work for more than two segements."
                    )
                    error_msg.exec_()
                else:
            ...
            if self.seifdamip.isChecked():
                if gNumberOfSegs > 2:
                    ...
                    error_msg.setInformativeText(
                        "SEIFDA-MILP does not work for more than two segements."
                    )
                    error_msg.exec_()
                else:
            ...
            if self.nc.isChecked():
                if gNumberOfSegs > 2:
                    ...
                    error_msg.setInformativeText(
                        "Necessary Condition does not work for more than two segements."
                    )
            ...
            if self.casini18.isChecked():
                gSchemes.append("Casini18")
                ...
                if len(gSchemes) != 0:
                    try:
                        ...
                        MainWindow.statusBar().showMessage(
                            "Testing the given configurations..."
                        )
            ...
            if gmpCheck:
                if len(gSchemes) != 0:
                    try:
                        effsstsPlot.effsstsPlotAllmulti(
                            gPrefixdata,
                            gPlotall,
                            gmultiplot,
                            garwrap,
...
def tasksetConfiguration():
    ...
    if (
        ...
        or gTaskChoice == "Generate and Save Tasksets"
    ):
        random.seed(gSeed)
        ...
        if gTaskChoice == "Generate and Save Tasksets":
            file_name = (
                "Ts-"
                + str(gNumberOfTaskSets)
                + "-Tn-"
                + str(gNumberOfTasksPerSet)
                + "-Ust-"
                + str(gUStep)
                + "-Ssl-"
                + str(gSLenMinValue)
    ...
    for tasks in tasksets:
        if ischeme == "SCEDF":
            ...
            if pass_opa.PASS_OPA(tasks, ischeme) == False:
                counter += 1
        elif ischeme == "Casini18":
            if casini18.sched_test(tasks) == False:
                counter += 1
            ...
            ischeme.split("-")[0] == "Oblivious"
            or ischeme.split("-")[0] == "Clairvoyant"
        ):
...
def evaluate_multiple_tasksets_multiple_schemes(tasksets, ischemes):
    result = [
        [
            True if switchTest([taskset], ischeme, 0) == 0 else False
            for ischeme in ischemes
        ]
